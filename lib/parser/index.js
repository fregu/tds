    ...
    resolve(item, config) {
      ...
      config.store = {
        ...
        middlewares:
          ...
          (middlewares && middlewares.type === "file" && [middlewares.path]) ||
          []
      };
    }
  }
...
module.exports = function(dir) {
  ...
  const config = {
    ...
    node_modules: {
      redux: nodeModules.includes("redux"),
      "react-redux": nodeModules.includes("react-redux"),
      graphql: nodeModules.includes("graphql"),
      "react-router-dom": nodeModules.includes("react-router-dom"),
      "react-router": nodeModules.includes("react-router"),
      "react-apollo": nodeModules.includes("react-apollo")
    },
    ...(defaultConfig || {}),
    ...(configFile ? require(path.resolve(dir, configFile.path)) : {})
  };
